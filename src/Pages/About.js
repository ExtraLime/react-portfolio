...
const About = () => {
    return (
       <div>
          <h1>About Me</h1>
          <article>
             By now you know my name is Will Morgan. If you came from the TL;DR page then you may have read 
             <a target='_blank' href='http://pdxcrimemap.net' rel="noopener noreferrer" data-tip data-for='tldr-talk'> this
                                 </a>
                            <ReactTooltip style={{maxWidth:"300px"}} id='tldr-talk' place='bottom' color='dodgerblue' effect='solid'>
                            <span>A multilingual international entrepeneur, 
                              ...
                              deadline oriented, and always curious.</span>
                            </ReactTooltip>. 
                            Obviously as a fellow human, we are all so much more than the 
                            ...
                            <div>
                               <h5>Briefly</h5> 
                                 <p>I went to highschool in the Pacific Northwest, traveling around the world during the summer. 
                                    ...
                                    a teller to pay for my education. Infact, I'm still paying for my education. 
                           ...
                           <div>
                               <h5>Then I moved to Africa</h5> 
                                 <p>I spent most of my late 20s in the Ivory Coast. Trading cocoa (physical and paper) and cashews.
                                    ...
                                    processed raw cashew nuts. I traveled to Dubai, Singapore, and China to meet with suppliers, engage
                                    trading partners and sign large contracts clients. I imported the machinery necessary necessary to
